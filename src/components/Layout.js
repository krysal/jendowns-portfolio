...
const Header = () => (
  <header>
    <Helmet>
      ...
      <meta content='I use code to create compelling and delightful digital experiences.' name='Description' />
      ...
      <meta property="og:description" content="I use code to create compelling and delightful digital experiences." />
      ...
      <meta property="twitter:description" content="I use code to create compelling and delightful digital experiences." />
